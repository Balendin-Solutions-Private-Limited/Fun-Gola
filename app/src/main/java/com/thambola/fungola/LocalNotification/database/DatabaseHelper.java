package com.thambola.fungola.LocalNotification.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "FUNGOLA_DB";
    ...
    private void addAllIcons(SQLiteDatabase database) {
       ...
       // String icons = context.getResources().getString()
        for (int i = 0; i < icons.length; i++) {
            ContentValues values = new ContentValues();
            values.put(COL_ICON_ID, 0);
